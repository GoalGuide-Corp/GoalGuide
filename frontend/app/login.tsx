    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            if (response.data && response.data.token && response.data.userId) {
                ...
                await AsyncStorage.setItem('userId', response.data.userId); // Store userId in AsyncStorage
                await AsyncStorage.setItem('isNewUser', 'false');

                console.log('Token, userId, and onboarding status saved to AsyncStorage');
                router.push('/main');
            } else {
                console.error('Token or User ID not found in the response data');
            }
        } catch (error: any) {
